...
make_tests(App) ->
    ...
    GeneratedTestDir = Root ++ "/test/generated_tests",
    ok = file:del_dir_r(GeneratedTestDir),
...
gen_test2(Filename, Lines, GeneratedTestDir) ->
    ...
    case Body of
        [] -> ok;
        _  -> Disclaimer = "%%% DO NOT EDIT this test suite is generated by the pometo_docs_to_test rebar3 plugin\n\n",
